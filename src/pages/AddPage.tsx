...
const AddPage: React.FunctionComponent<IAddPageProps> = (props) => {
    ...
    return (
        <div>
            <h1 className="text-2xl pb-10 ml-4 font-semibold">Добавление {getTitle(type)}</h1>
            ...
            <div className="flex flex-row justify-end space-x-6 pt-6 ">
                <button
                    className={"bg-my-purple hover:opacity-80 shadow-2xl rounded-2xl py-2 px-4 text-my-white"}>Добавить пост
                </button>
